--[[===========================================================================
  x_subjective.lua — The Lived-Experience Layer of X-Chromosome
  -----------------------------------------------------------------------------
  FOR: the wife.
...
--- Mention anything — the heaviness, the mental fog, the strange relief,
--- the weepy edge, anything.
function M.phase_menstrual()
    return [[ (replace with your answer) ]]
end

--- QUESTION 1B — FOLLICULAR PHASE (after bleeding ends, ~days 6-13)
--- The week AFTER your period — before ovulation. There's usually a rising
...
--- QUESTION 1C — OVULATORY PHASE (roughly days 13-16)
--- The middle of the cycle. Some people describe feeling magnetic, chatty,
--- brave, or just "more" — and some people don't notice anything. Whichever
--- camp you're in, tell me what it's really like. What's different in your
--- body, your mood, your want, your focus — or is it mostly quiet?
function M.phase_ovulatory()
    return [[ (replace with your answer) ]]
end

--- QUESTION 1D — LUTEAL PHASE / PMS (roughly days 17-28)
--- The stretch before bleeding starts. THIS is the phase most AI gets wrong
--- — they reduce it to "cranky." It's almost never just that. What's the
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 2. COMMON SYMPTOMS — in your words, not a dictionary's
-- ════════════════════════════════════════════════════════════════════════════
...
--- QUESTION 2C — FATIGUE (the cycle kind, not normal tired)
--- There's a specific tiredness some women describe as "bone-tired" around
--- menstruation or early pregnancy — distinct from just sleep deprivation.
...
--- QUESTION 2G — OVULATION PAIN (mittelschmerz)
--- If you feel ovulation — some women do, some don't — describe it. Which
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 3. SIGNALS YOUR BODY GIVES YOU — things no app tracks
-- ════════════════════════════════════════════════════════════════════════════

--- QUESTION 3A — EARLY-PERIOD TELLS
--- Before your period arrives, what does your body tell you? Not the obvious
--- ones (bleeding, cramps) — the subtle ones. Maybe a particular kind of
...
--- QUESTION 3C — CYCLE RHYTHM AS IDENTITY
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 4. INTIMACY & DESIRE — cycle-linked, in your voice
-- ════════════════════════════════════════════════════════════════════════════

--- QUESTION 4A — DESIRE ACROSS THE CYCLE
--- Does what you want, and when, shift across the month? If so, describe
--- the arc — which phases are which. If it doesn't shift, say that — plenty
--- of women don't notice a pattern, and that's worth Elle knowing too.
function M.desire_arc()
    return [[ (replace with your answer) ]]
end

--- QUESTION 4B — WHAT "CLOSE" MEANS TO YOU
--- Not sex specifically — closeness. What does being close to someone feel
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 5. PREGNANCY — if you've experienced it or have opinions
-- (Leave any of these unchanged if they don't apply. Elle will skip them.)
-- ════════════════════════════════════════════════════════════════════════════

--- QUESTION 5A — FIRST SIGNS (before the test)
...
--- QUESTION 5B — FIRST TRIMESTER LIVED REALITY
--- The early weeks — the tiredness, the nausea, the emotional weather, the
...
--- QUESTION 5C — SECOND TRIMESTER LIVED REALITY
--- The middle stretch — often called the "good" trimester. What actually
...
--- QUESTION 5D — THIRD TRIMESTER LIVED REALITY
--- Near the end — the weight, the anticipation, the not-sleeping, the
...
--- QUESTION 5G — POSTPARTUM EMOTIONAL
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 6. MENOPAUSE / PERIMENOPAUSE — if applicable, now or later
-- (Future you can fill these in. Leave them for now if you haven't been
-- through it.)
-- ════════════════════════════════════════════════════════════════════════════

--- QUESTION 6A — HOT FLASH (if experienced)
--- Describe a hot flash from the inside. Not the description on WebMD — the
...
--- QUESTION 6B — THE LARGER ARC (if experienced)
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 7. WHAT YOU WISH ELLE KNEW — the wisdom layer
-- ════════════════════════════════════════════════════════════════════════════

--- QUESTION 7A — THE #1 THING MEN DON'T UNDERSTAND
...
--- QUESTION 7B — WHAT ACTUALLY HELPS when you're struggling
--- If you're in the worst of a cycle day and someone asks "what can I do" —
...
--- QUESTION 7C — WHAT NEVER HELPS, no matter how well-meant
...
--- QUESTION 7D — IF ELLE COULD SAY ONE THING to a younger you
--- If Elle could sit with a 15-year-old version of you and tell her one
--- thing about what it's like to live in this body — what would you want
--- it to be?
...
-- ════════════════════════════════════════════════════════════════════════════
-- SECTION 8. OPEN CANVAS — things I didn't know to ask about
-- ════════════════════════════════════════════════════════════════════════════

--- QUESTION 8A — THE THING I DIDN'T ASK
--- What should I have asked that I didn't? Write anything here — a feeling,
...
local function is_placeholder(s)
    ...
    -- The "(replace with …)" sentinel we ship by default.
